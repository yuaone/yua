  ...
  return (
    <button
      ...
      className={[
        ...
        "rounded-lg px-2 py-1.5 transition max-lg:px-3 max-lg:py-2.5",
 active
      ...
      <div className="flex-1 min-w-0">
          ...
          <div
            className={[
             ...
             "max-lg:text-[16px] max-lg:leading-[1.3]",
              active ? "font-semibold text-[var(--sb-ink)]" : "font-medium text-[var(--sb-ink)]",
            ].join(" ")}
          >
