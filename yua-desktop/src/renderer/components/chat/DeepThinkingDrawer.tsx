...
export default function DeepThinkingDrawer(props: Props) {
  ...
  // SSOT: Body shared between mobile/desktop (no duplication)
  const Body = (
  ...
  const Panel = (
    <>
      ...
      {/* Desktop Drawer (grid column content only) */}
